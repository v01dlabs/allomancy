...
impl fmt::Display for IoctlKind {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        match *self {
            ...
            IoctlKind::LineInfoV2 => write!(f, "get line info"),
            IoctlKind::LineConfigV2 => write!(f, "set line config"),
            IoctlKind::LineV2 => write!(f, "get line"),
            IoctlKind::LineInfoWatch => write!(f, "watch line info for changes"),
            IoctlKind::LineInfoUnwatch => write!(f, "stop watching line info for changes"),
            IoctlKind::GetLineV2 =>  write!(f, "get line value"),
            IoctlKind::SetLineV2 => write!(f, "set line value"),
        }
    }
}
