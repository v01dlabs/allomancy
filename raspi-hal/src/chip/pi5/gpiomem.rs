...
impl GpioMem {
    ...
    fn direction(&self, pin: u8) -> PinMode {
    ...
    fn set_direction(&self, pin: u8, mode: PinMode ) {
        let offset = match mode {
            PinMode::Output => (SYS_RIO0_OFFSET + RIO_OE + SET_OFFSET) / REG_SIZE,
...
impl GpioRegisters for GpioMem {
    ...
    fn mode(&self, pin: u8) -> PinMode {
        ...
        match (reg_value & CTRL_FUNCSEL_MASK) as u8 {
            ...
            FSEL_ALT6 => PinMode::Alt6,
            FSEL_ALT7 => PinMode::Alt7,
            FSEL_ALT8 => PinMode::Alt8,
            _ => PinMode::Input,
        }
    }
    ...
    fn set_mode(&self, pin: u8, mode: PinMode) {
        ...
        let fsel_mode = match mode {
            PinMode::Input => FSEL_ALT5,  // GPIO
            PinMode::Output => FSEL_ALT5, // GPIO
            ...
            PinMode::Alt6 => FSEL_ALT6,
            PinMode::Alt7 => FSEL_ALT7,
            PinMode::Alt8 => FSEL_ALT8,
            _ => FSEL_ALT5,
        };
    ...
    fn set_bias(&self, pin: u8, bias: Bias) {
        ...
        reg_value = match bias {
            Bias::Floating => (reg_value & !PADS_BIAS_MASK) | (PADS_BIAS_OFF << PADS_BIAS_LSB),
